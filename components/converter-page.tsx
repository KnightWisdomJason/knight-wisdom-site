...
const copy = {
  en: {
    navigation: { blog: "Blog", computer: "Computer tools", documents: "Document tools", images: "Image tools", business: "Business tools" }, languageLabel: "Choose language",
  ...
  "zh-CN": {
    navigation: { blog: "博客", computer: "计算机工具", documents: "文档工具", images: "图片工具", business: "商业工具" }, languageLabel: "选择语言",
