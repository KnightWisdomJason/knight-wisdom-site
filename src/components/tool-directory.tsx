...
export function ToolDirectory({ tools }: { tools: Tool[] }) {
  const params = useSearchParams(); const query = params.get("q") || ""; const [category, setCategory] = useState("All Tools"); const categories = ["All Tools", "Text", "Developer", "Encoding"];
