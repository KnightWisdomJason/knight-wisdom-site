...
const content = {
  en: {
    ...
    tools: [
      ...
      { group: "document-tools", icon: "⇄", title: "PDF Converter", description: "Convert PDF files simply and securely." },
      ...
      { group: "document-tools", icon: "▣", title: "JPG to PDF", description: "Turn images into a shareable PDF document." },
  ...
  "zh-CN": {
    ...
    tools: [
      ...
      { group: "document-tools", icon: "⇄", title: "PDF 转换", description: "简单、安全地转换 PDF 文件。" },
      ...
      { group: "document-tools", icon: "▣", title: "JPG 转 PDF", description: "将图片转换成方便分享的 PDF 文档。" },
