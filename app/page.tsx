...
const content = {
  en: {
    ...
    tools: [
      ...
      { group: "pdf-tools", icon: "✎", title: "Edit PDF", description: "Edit, annotate, sign, and export PDFs in your browser.", href: "/tools/pdf-editor", badge: "NEW" },
      { group: "pdf-tools", icon: "▤", title: "Merge PDF", description: "Combine documents into one organized PDF." },
      { group: "pdf-tools", icon: "✂", title: "Split PDF", description: "Separate pages into the files you need.", href: "/tools/split-pdf", badge: "NEW" },
  ...
  "zh-CN": {
    ...
    tools: [
      ...
      { group: "pdf-tools", icon: "✎", title: "PDF 在线编辑", description: "直接在浏览器中编辑、标注、签名并导出 PDF。", href: "/tools/pdf-editor", badge: "新功能" },
      { group: "pdf-tools", icon: "▤", title: "PDF 合并", description: "将文档合并为一个井然有序的 PDF。" },
      { group: "pdf-tools", icon: "✂", title: "PDF 拆分", description: "将页面拆分为所需的独立文件。", href: "/tools/split-pdf", badge: "新功能" },
